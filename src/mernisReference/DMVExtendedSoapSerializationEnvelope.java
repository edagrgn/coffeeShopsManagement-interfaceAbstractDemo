...
public class DMVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DMVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DMVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DMVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DMVDateTimeConverter dateTimeConverter = new DMVStandardDateTimeConverter();

    public DMVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DMVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DMVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DMVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DMVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DMVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
