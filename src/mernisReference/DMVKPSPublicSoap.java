...
public class DMVKPSPublicSoap
{
    ...
    public DMVKPSPublicSoap(){}

    public DMVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DMVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DMVExtendedSoapSerializationEnvelope envelope= new DMVExtendedSoapSerializationEnvelope(DMVExtendedSoapSerializationEnvelope.VER11);
